// src/components/ArcGISContainerDensityLayer.jsx
import React, { useEffect, useRef, useState } from 'react';

const ArcGISContainerDensityLayer = ({
  map,
  ...
  const initializeLayer = () => {
    ...
    try {
      ...
      console.error('Error initializing container density layer:', error);
      setIsLoading(false);
      onLoadingChange?.(false);
    }
  };
...
export default ArcGISContainerDensityLayer;