// src/components/ArcGISPipelineLayer2.jsx
import React, { useEffect, useRef, useState } from 'react';
import maplibregl from 'maplibre-gl';
import { createRoot } from 'react-dom/client';
import PipelinePopup from '../../popups/pipeline/Pipeline2Popup';

const ArcGISPipelineLayer2 = ({
  map,
  ...
  const fetchFeatures = async () => {
    try {
      ...
      // Endpoint for Helcom pipelines 2: MapServer/175
      const baseUrl = 'https://maps.helcom.fi/arcgis/rest/services/MADS/Pressures/MapServer/175';
      ...
      console.error('Error fetching Helcom pipelines 2:', error);
      return null;
    } finally {
      setIsLoading(false);
  ...
  const initializeLayer = () => {
    ...
    try {
        ...
        map.addLayer(
          {
            ...
            paint: {
              'line-color': '#FFBB00',  // Changed from rgb(255, 187, 0) to hex color
              'line-width': 2,
              'line-opacity': 0.8
            }
          },
      ...
      console.error('Error initializing Helcom pipelines 2 layer:', error);
    }
  };
  ...
  const setupInteractivity = () => {
    ...
    map.on('click', layerId, (e) => {
      ...
      root.render(<PipelinePopup properties={properties} />);
...
export default ArcGISPipelineLayer2;
